...
class FoodForecastPage extends StatefulWidget {
  const FoodForecastPage({super.key});

  @override
  _FoodForecastPageState createState() => _FoodForecastPageState();
}

class _FoodForecastPageState extends State<FoodForecastPage> {
  final logic = Get.put(FoodForecastLogic());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<FoodForecastLogic>(
