...
public class SysOperlogController extends BaseController
{
    ...
    @Log(title = "OperationLog", businessType = BusinessType.EXPORT)
    ...
    @Log(title = "OperationLog", businessType = BusinessType.DELETE)
    ...
    @Log(title = "OperationLog", businessType = BusinessType.CLEAN)
    @PreAuthorize("@ss.hasPermi('monitor:operlog:remove')")
    @DeleteMapping("/clean")
