...
import com.ht.framework.web.service.SysPasswordService;
...
public class SysLogininforController extends BaseController
{
    ...
    public void export(HttpServletResponse response, SysLogininfor logininfor)
    {
        ...
        util.exportExcel(response, list, "LoginLog");
    }
    ...
    @PreAuthorize("@ss.hasPermi('monitor:logininfor:remove')")
    @Log(title = "LoginLog", businessType = BusinessType.CLEAN)
    @DeleteMapping("/clean")
    ...
    @Log(title = "unlockAccount", businessType = BusinessType.OTHER)
